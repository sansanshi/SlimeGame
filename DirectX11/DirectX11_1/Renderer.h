...
private:
	...
	//ライトからの視点（カラー
	ID3D11RenderTargetView* _lightRTV_color;
	ID3D11DepthStencilView* _lightDSV_color;
	...
	ID3D11ShaderResourceView* _shaderResourceView_color;//スライムの影（半透明）用
...
public:
	...
	void ChangeRT_Light();
	void ChangeRT_LightColor();//カメラからの視点（カラー
	...
	ID3D11ShaderResourceView* LightViewShaderResource(){ return _shaderResourceView_color; };
