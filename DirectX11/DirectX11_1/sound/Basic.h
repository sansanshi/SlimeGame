 ...
 *  File Path        : C:/cri/pc/samples/criatom/AtomCraftWork/Public/inGamePreview/Basic.acb
 *  File Name        : Basic.acb
 *  File Size        : 73,600 bytes
 *  Date Time        : 2016/03/30 15:22
 *  Target           : Public
 *  Cues             : 9
 *  CueSheet Comment : 
 *  Stream Awb Path  : Basic.awb
 *===========================================================================*/
