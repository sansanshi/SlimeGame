...
Plane::Plane(Camera* camera) :_cameraPtr(camera)
{
};

Plane::Plane(float width, float depth, Vector3 normal,Camera* camera) :_cameraPtr(camera)
{
...
Plane::DrawCameraDepth()
{
	...
	//
	XMMATRIX cameraView = _cameraPtr->CameraView();
